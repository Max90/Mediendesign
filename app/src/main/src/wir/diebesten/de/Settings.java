...
public class Settings extends ActionBarActivity implements OnClickListener, android.widget.AdapterView.OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> arg, View item, int pos, long arg3) {
		//hier item in liste überprüfen und je nach item neues int an intend übergeben
