...
public class SettingsSpecific extends ActionBarActivity implements
	...
	private int[] getIntentContent() {
		...
		case 4:
			// hier revidieren
			// unterpunkte bass....
			// dann boxenübersicht! mit jeweils 1er einstellmöglichkeit 
			// und auswahlhäkchen um alle einzustellen!!!
